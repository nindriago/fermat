...
public enum AssetFactoryFragmentsEnumType implements FermatFragmentsEnumType<AssetFactoryFragmentsEnumType> {
   ...
   /* DAP_SUB_APP_ASSET_FACTORY_DRAFT_TAB_FRAGMENT("DAPSAAFETF"),
    DAP_SUB_APP_ASSET_FACTORY_PUBLISHED_TAB_FRAGMENT("DAPSAAFPTF"),
    DAP_SUB_APP_ASSET_EDITOR_FRAGMENT("DSAAEAF"),
    DAP_SUB_APP_ASSET_FACTORY_SETTINGS_FRAGMENT("DSAAFSF"),
    DAP_SUB_APP_ASSET_FACTORY_SETTINGS_NETWORK_MAIN_FRAGMENT("DSAAFSNMF"),
    DAP_SUB_APP_ASSET_FACTORY_SETTINGS_NOTIFICATIONS_FRAGMENT("DSAAFNF");
    */

        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                if (s.equals(searchView.getQuery().toString())) {
                    ...
                    appSession.setData("issuer_community_search", s);
                }
                return false;
            }
        });
        if (appSession.getData("issuer_community_search") != null) {
            String s = appSession.getData("issuer_community_search").toString();

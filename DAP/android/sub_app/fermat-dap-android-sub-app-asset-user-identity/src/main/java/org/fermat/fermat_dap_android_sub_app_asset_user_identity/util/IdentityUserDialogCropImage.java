package org.fermat.fermat_dap_android_sub_app_asset_user_identity.util;
 ...
 */
public class IdentityUserDialogCropImage extends FermatDialog implements View.OnClickListener{
    ...
    Bitmap image;
    Bitmap croppedImage;
    public IdentityUserDialogCropImage(Context activity, FermatSession fermatSession, ResourceProviderManager resources, Bitmap image) {
    ...
    protected int setLayoutId() {
        return R.layout.dap_users_identity_dialog_crop_image;
    }

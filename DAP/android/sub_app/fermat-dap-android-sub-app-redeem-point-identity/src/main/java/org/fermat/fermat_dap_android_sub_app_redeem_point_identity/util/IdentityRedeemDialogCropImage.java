package org.fermat.fermat_dap_android_sub_app_redeem_point_identity.util;
 ...
 */
public class IdentityRedeemDialogCropImage extends FermatDialog implements View.OnClickListener{
    ...
    Bitmap image;
    Bitmap croppedImage;
    public IdentityRedeemDialogCropImage(Context activity, FermatSession fermatSession, ResourceProviderManager resources, Bitmap image) {
    ...
    protected int setLayoutId() {
        return R.layout.dap_redeem_identity_dialog_crop_image;
    }

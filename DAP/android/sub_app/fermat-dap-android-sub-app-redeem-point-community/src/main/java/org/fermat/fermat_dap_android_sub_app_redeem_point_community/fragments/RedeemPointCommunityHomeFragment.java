        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                if (s.equals(searchView.getQuery().toString())) {
                    ...
                    appSession.setData("redeem_point_community_search", s);
                }
                return false;
            }
        });
        if (appSession.getData("redeem_point_community_search") != null) {
            String s = appSession.getData("redeem_point_community_search").toString();

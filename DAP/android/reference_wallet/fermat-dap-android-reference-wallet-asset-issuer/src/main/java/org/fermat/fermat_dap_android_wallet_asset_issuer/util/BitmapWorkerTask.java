package org.fermat.fermat_dap_android_wallet_asset_issuer.util;
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if(imageViewReference != null) {
                ...
                if (bitmap != null) {
                    ...
                    if(isCircle)
                    Picasso.with(imageView.getContext()).load(R.drawable.issuer_profile).transform(new CircleTransform()).into(imageView);
                    else Picasso.with(imageView.getContext()).load(R.drawable.issuer_profile).into(imageView);

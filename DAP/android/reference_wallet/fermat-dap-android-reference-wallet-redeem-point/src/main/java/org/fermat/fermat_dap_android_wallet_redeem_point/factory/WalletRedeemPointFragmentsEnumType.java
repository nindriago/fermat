...
public enum WalletRedeemPointFragmentsEnumType implements FermatFragmentsEnumType<WalletRedeemPointFragmentsEnumType> {
    ...
    /*DAP_WALLET_REDEEM_POINT_STADISTICS_FRAGMENT("DWRPSF"),
    DAP_WALLET_REDEEM_POINT_ASSET_SETTINGS_FRAGMENT("DWRPASF"),
    DAP_WALLET_REDEEM_POINT_SETTINGS_MAIN_NETWORK_FRAGMENT("DWRPSMNF"),
    DAP_WALLET_REDEEM_POINT_ASSET_SETTINGS_NOTIFICATIONS_FRAGMENT("DWRPASNF"),
    */

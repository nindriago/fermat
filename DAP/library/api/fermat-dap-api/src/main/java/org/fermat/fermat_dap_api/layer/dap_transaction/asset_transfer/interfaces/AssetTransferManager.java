...
public interface AssetTransferManager extends FermatManager {
    void transferAssets(HashMap<DigitalAssetMetadata, org.fermat.fermat_dap_api.layer.dap_actor.asset_user.interfaces.ActorAssetUser> digitalAssetsToDistribute, String walletPublicKey) throws CantTransferDigitalAssetsException;
}
